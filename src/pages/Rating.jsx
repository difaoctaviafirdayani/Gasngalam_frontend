      ...
      <div className="content">
        ...
        <div className="add-review-box">
          ...
          <div className="star-select">
            ...
            <span style={{ fontSize: 12, color: 'var(--text4)', marginLeft: 8 }}>
          ...
          <div style={{ marginBottom: 12 }}>
            ...
            {!photoPreview ? (
              <button
                ...
                style={{ padding: '7px 16px', border: '1.5px dashed var(--border)', borderRadius: 8, background: 'var(--bg)', cursor: 'pointer', fontSize: 12, color: 'var(--text3)', fontFamily: 'Inter,sans-serif' }}
              >
                + Lampirkan Foto
              </button>
            ) : (
              <div style={{ position: 'relative', display: 'inline-block' }}>
                <img src={photoPreview} alt="preview" style={{ height: 90, borderRadius: 8, objectFit: 'cover', border: '1px solid var(--border)' }} />
                <button
                  onClick={removePhoto}
