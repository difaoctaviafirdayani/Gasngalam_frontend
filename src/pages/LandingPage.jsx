...
const whyUs = [
  {
    ...
    desc: 'Ratusan tempat menarik menanti untuk dijelajahi.',
  },
  {
    icon: <FaTrophy />,
    title: 'Terbaik & Terpercaya',
    desc: 'Informasi akurat dan selalu diperbarui.',
  },
  {
    icon: <FaThumbsUp />,
    title: 'Mudah & Praktis',
    desc: 'Cari informasi wisata dengan cepat dan mudah.',
  },
  {
    icon: <FaHeart />,
    title: 'Pengalaman Berkesan',
    desc: 'Ciptakan kenangan terindah di Malang.',
  },
];
...
const heroFeatures = [
  {
    ...
    desc: 'Rekomendasi tempat wisata terbaik di Malang.',
  },
  {
    icon: <FaUtensils />,
    title: 'Kuliner Legendaris',
    desc: 'Nikmati berbagai kuliner khas yang menggugah selera.',
  },
  {
    icon: <FaCalendarAlt />,
    title: 'Event Seru',
    desc: 'Informasi event menarik yang tak boleh dilewatkan.',
  },
  {
    icon: <FaMapMarkedAlt />,
    title: 'Panduan Lengkap',
    desc: 'Semua informasi yang kamu butuhkan untuk berwisata.',
  },
];
...
// Fallback gradient per kategori jika foto gagal load
  ...
  useEffect(() => {
    fetch('http://localhost:8000/api/destinations?limit=5&sort=popular')
      ...
      .then(data => {
        ...
        const withPhoto = list.filter(d => d.photo_full_url);
        setDestinations(withPhoto.slice(0, 5));
      })
        ...
        <div style={{
          ...
          <div style={{ maxWidth: 560 }}>
            <h1 style={{
              ...
              lineHeight: 1.05, marginBottom: 20, letterSpacing: '-1px', color: '#fff',
            }}>
              Rasakan <br />
            ...
            <p style={{
              ...
              Temukan destinasi wisata terbaik, kuliner lezat, budaya unik,
              dan pengalaman seru di setiap sudut Kota Malang.
            </p>
            <button
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10, width: 280, flexShrink: 0 }}>
            {heroFeatures.map(({ icon, title, desc }) => (
              <div key={title} style={{
                ...
                alignItems: 'flex-start', transition: 'all .25s',
              }}
              ...
              >
                <div style={{
                  width: 38, height: 38, borderRadius: 10, background: goldPale,
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  fontSize: 18, flexShrink: 0, color: gold,
      ...
      <section style={{ padding: '80px 60px', background: sectionBg, transition: 'background .3s' }}>
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 40 }}>
            <div>
              <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: '2.5px', textTransform: 'uppercase', color: gold, marginBottom: 10 }}>
                DESTINASI POPULER
              </div>
              <h2 style={{
                fontSize: 'clamp(26px, 3.5vw, 38px)', fontWeight: 800,
                color: textPrimary, letterSpacing: '-0.5px', marginBottom: 10,
              }}>
                  ...
                  return (
                    <div
                      ...
                      onMouseEnter={e => {
                        ...
                        e.currentTarget.style.boxShadow = isDark ? '0 16px 40px rgba(0,0,0,0.4)' : '0 16px 40px rgba(0,0,0,0.12)';
                      }}
                      onMouseLeave={e => {
                      ...
                      <div style={{
                        ...
                        {photoUrl && (
                          <img
                            ...
                            onError={e => {
                              // Jika foto gagal load, gradient bg tetap tampil
        ...
        <div style={{
          ...
          <div>
            ...
            <h2 style={{
              ...
              color: textPrimary, lineHeight: 1.15, letterSpacing: '-0.5px', marginBottom: 16,
            }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 28 }}>
            {whyUs.map(({ icon, title, desc }) => (
              <div key={title} style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                <div style={{
                  width: 44, height: 44, borderRadius: 12, background: goldPale,
                  border: `1px solid ${isDark ? 'rgba(201,162,39,0.25)' : 'rgba(201,162,39,0.3)'}`,
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
      ...
      <section style={{ padding: '70px 60px 110px', background: sectionBg, transition: 'background .3s' }}>
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          <div style={{
            ...
            minHeight: 480, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '80px 40px',
          }}>
            <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(135deg, rgba(5,7,15,0.92) 0%, rgba(5,7,15,0.78) 100%)' }} />
            <div style={{
              position: 'relative', zIndex: 2, textAlign: 'center',
              maxWidth: 700, display: 'flex', flexDirection: 'column', alignItems: 'center',
            }}>
              <h2 style={{
                fontSize: 'clamp(38px, 4vw, 62px)', fontWeight: 900,
                lineHeight: 1.1, marginBottom: 20, color: '#fff', letterSpacing: '-1px',
              }}>
                Masih Bingung<br />
                <span style={{ color: gold }}>Mau Liburan ke Mana?</span>
              </h2>
              ...
              <button
                ...
                style={{
                  ...
                  background: gold, border: 'none',
                  color: '#0a0c14', fontSize: 17, fontWeight: 800,
